...
namespace Codice.Views.Diff
{
    ...
    public class UnityDiffTree
    {
        ...
        public void BuildCategories(List<ClientDiff> diffs, bool skipMergeTracking)
        {
            mInnerTree.BuildCategories(diffs, skipMergeTracking);
            mMetaCache.Build(mInnerTree.GetNodes());
        }

        public List<IDiffCategory> GetNodes()
        {
            return mInnerTree.GetNodes();
        }

        public bool HasMeta(ClientDiffInfo difference)
        {
        ...
        class MetaCache
        {
            ...
            static class BuildKey
            {
                    ...
                    string path)
                {
                    ...
                    return string.Concat(mergeCategory.GetCategoryName(), ":", result);
                }
