...
namespace Codice.Views.Diff.Dialogs
{
    public class GetRestorePathDialog : PlasticDialog
    {
        protected override Rect DefaultRect
        {
            get
            {
                ...
                return new Rect(baseRect.x, baseRect.y, 600, 150);
            }
        }

        public static GetRestorePathData GetRestorePath(
            string wkPath,
            string restorePath,
            string explanation,
            bool isDirectory,
