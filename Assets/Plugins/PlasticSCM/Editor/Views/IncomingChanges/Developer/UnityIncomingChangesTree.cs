...
namespace Codice.Views.IncomingChanges.Developer
{
    ...
    public class UnityIncomingChangesTree
    {
        public static UnityIncomingChangesTree BuildIncomingChangeCategories(
        ...
        public List<IncomingChangesCategory> GetNodes()
        {
            return mInnerTree.GetNodes();
        }

        public bool HasMeta(IncomingChangeInfo changeInfo)
        {
            return mMetaCache.ContainsMeta(changeInfo);
        }

        public IncomingChangeInfo GetMetaChange(IncomingChangeInfo change)
        {
