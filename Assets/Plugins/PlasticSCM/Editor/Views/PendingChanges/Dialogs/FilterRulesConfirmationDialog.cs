...
{
    public class FilterRulesConfirmationDialog : PlasticDialog
    {
        ...
        public static FilterRulesConfirmationData AskForConfirmation(
            string[] rules,
            bool isAddOperation,
        ...
        {
            return Create(mDialogExplanation, mRulesText, mIsApplicableToAllWorkspaces);
        }
