...
namespace Codice.Views.PendingChanges.Dialogs
{
    internal class PendingChangesOptionsDialog : PlasticDialog
    {
        ...
        {
            return Create(mWorkspaceInfo, mIsGluonMode);
        }
        ...
        static PendingChangesOptionsDialog Create(WorkspaceInfo wkInfo, bool isGluonMode)
        {
            var instance = CreateInstance<PendingChangesOptionsDialog>();
            instance.mWorkspaceInfo = wkInfo;
