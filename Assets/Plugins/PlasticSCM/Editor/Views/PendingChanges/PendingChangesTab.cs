...
{
    public class PendingChangesTab :
        IRefreshableView,
    ...
    {
        public IProgressControls ProgressControlsForTesting { get { return mProgressControls; } }
        public HelpPanel HelpPanelForTesting { get { return mHelpPanel; } }

        public PendingChangesTab(
            ...
            EditorWindow plasticWindow)
        {
            ...
            mPendingChangesTreeView = new PendingChangesTreeView(
                ...
                new PendingChangesViewMenu(this, this, this));
