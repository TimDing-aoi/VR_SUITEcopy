...
namespace Codice.Views.Changesets
{
        ...
        ChangesetsViewMenu.IMenuOperations
    {
        ...
        {
            List<RepObjectInfo> selectedChangesets = 
            ...
            waiter.Execute(
                ...
                /*afterOperationDelegate*/ delegate
                {
                    try
                    {
                        ...
                        UpdateChangesetsList(mChangesetsListView, queryResult);
        ...
        static string GetChangesetsQuery(
            ...
            EditorWindow parentWindow)
        {
            ...
            mDiffPanel = new DiffPanel(
                wkInfo, workspaceWindow, viewSwitcher, parentWindow);
        }
