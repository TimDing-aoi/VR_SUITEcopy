...
{
    public class ChannelCertificateUiImpl : IChannelCertificateUI
    {
        public ChannelCertificateUiImpl()
        {
        }

        public CertOperationResult AcceptNewServerCertificate(PlasticCertInfo serverCertificate)
        {
        ...
        public CertOperationResult AcceptChangedServerCertificate(PlasticCertInfo serverCertificate)
        {
            return GetUserResponse(
                PlasticLocalization.GetString(
