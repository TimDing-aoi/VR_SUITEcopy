...
{
    public class EncryptionConfigurationDialog : PlasticDialog
    {
        protected override Rect DefaultRect
        {
            get
            {
                ...
                return new Rect(baseRect.x, baseRect.y, 650, 300);
            }
        }

        public static EncryptionConfigurationDialogData RequestEncryptionPassword(
            string server,
